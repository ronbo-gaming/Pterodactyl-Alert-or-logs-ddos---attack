...
PTERO_API_URL = 'https://your-pterodactyl-url/admin/api'
PTERO_API_TOKEN = 'YOUR_PTERO_API_TOKEN'
...
async def ddos_status_command(ctx):
    embed = discord.Embed(title="DDoS Status", description=ddos_status, color=0x00ff00)
...
async def on_ready():
    ...
    update_ddos_status.start()  # Start the loop to periodically update DDoS status
